...
@section('content')
  <div class="hero-section">
     <div class="hero-section-inner">
        <div class="hero-text">
        <h1>Help someone out <span class="orange-text"> and contribute to their success</span></h1>
        <p class="lead py-2 gray-text">Crowdana is a Crowdfunding platform that allow registered user donate to people in need </p>
